...
everything else is an invalid number. ####valid phone is 8059161234:(803)-916-1234*/
                       if(digit[0]>621 && digit[0]<799 && digit[1]>900 && digit[1]<937)
                            {
                 //document.getElementById("demo").innerHTML = "You wrote: " +digit[0] 
                       ...
                       else if(digit[0]>801 && digit[0]<920 && digit[1]>900 && digit[1]<937)
                             {
                       ...
                       else if(digit[0]>921 && digit[0]<999 && digit[1]>900 && digit[1]<937 )
                            {
